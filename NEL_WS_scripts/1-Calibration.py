...
#%%
c = Camera([0, 1, 2, 3, 4], fps=[70,70,70,70,70], resolution=[Camera.RES_LARGE, Camera.RES_LARGE, Camera.RES_LARGE, Camera.RES_LARGE, Camera.RES_LARGE], colour=[False, False, False, False, False])
...
#%%
base_name = 'mov_recal_5_cam_'
filenames = ['0.npz', '1.npz', '2.npz',  '3.npz', '4.npz' ]
