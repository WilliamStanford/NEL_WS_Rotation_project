...
m1_views = ['0','2','4'] # Cameras - front left, front right, bot
...
model_1_coordinates.to_csv('/home/nel-lab/Desktop/WS_tests_for_DLC2/calibration2/model_1_coordinates.csv', index=False)
